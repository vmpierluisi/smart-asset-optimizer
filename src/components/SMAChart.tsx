...
interface SMAChartProps {
  data: SMAData;
  data50?: SMAData; // Optional 50-day SMA data
  data200?: SMAData; // Optional 200-day SMA data
  onTimeframeChange?: (timeframe: string) => void;
  timeframe?: string;
}

// Explicitly export the component
export const SMAChart: React.FC<SMAChartProps> = ({ 
  data, 
  data50, 
  data200, 
  onTimeframeChange,
